...
<div class="card white">
    <div class="card-content">
        <div class="col s12">
            <h3 class="center">Frutas Disponiveis</h3>
            <a href="<?= $this->Url->build(['controller' => 'Sales', 'action' => 'report']) ?>" class="waves-effect indigo darken-4 waves-light btn"><i class="material-icons left">add</i>Relatorio</a>
            <a href="<?= $this->Url->build(['controller' => 'Sales', 'action' => 'add']) ?>" class="waves-effect red accent-4 waves-light btn right"><i class="material-icons left">add</i>Venda</a>
        </div>
